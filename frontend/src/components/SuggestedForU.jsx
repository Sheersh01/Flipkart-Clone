...
const products = [
  {
    img: img1,
    name: "MAXTID 6 Layer White Orga...",
    rating: "4.5",
    originalPrice: "₹3,999",
    salePrice: "₹1,541",
    buyAt: "₹1,491",
  ...
  {
    img: img2,
    name: "MAXTID 5 Layer White Cabin...",
    rating: "4.1",
    originalPrice: "₹1,199",
    salePrice: "₹300",
    buyAt: "₹250",
  ...
  {
    img: img3,
    name: "MAXTID 5 Layer Whtet Cabi...",
    rating: "4",
    originalPrice: "₹1,599",
    salePrice: "₹799",
    buyAt: "₹749",
  ...
  {
    img: img4,
    name: "eshopy Organizer-5666 Clos...",
    rating: "",
    originalPrice: "₹1,099",
    salePrice: "₹473",
    buyAt: "₹423",
    ...
    <section className="suggested" id="suggested-for-you">
      <div className="container suggested-inner">
        ...
        <div className="suggested-products-wrap">
          ...
          {canScrollLeft && (
            <button
              className="suggested-scroll-btn suggested-scroll-btn--left"
              onClick={() => scroll("left")}
          ...
          {canScrollRight && (
            <button
              className="suggested-scroll-btn suggested-scroll-btn--right"
