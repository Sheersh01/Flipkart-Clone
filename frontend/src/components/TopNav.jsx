    ...
    <nav className="top-nav" id="top-nav">
      <div className="container top-nav-inner">
        <div className="top-nav-left">
          <a href="#" className="top-nav-btn top-nav-btn--flipkart" id="flipkart-btn">
            <img src={flipkartIcon} alt="Flipkart" className="top-nav-btn-icon" />
            <img src={flipkartLogo} alt="Flipkart" className="top-nav-btn-text" />
          </a>
          <a href="#" className="top-nav-btn top-nav-btn--minutes" id="minutes-btn">
            <img src={minutesIcon} alt="Minutes" className="top-nav-btn-icon" />
            <img src={minutesLogo} alt="Minutes" className="top-nav-btn-text" />
          </a>
          <a href="#" className="top-nav-btn top-nav-btn--travel" id="travel-btn">
        ...
        <div className="top-nav-right">
          <div className="top-nav-address" id="delivery-address">
            ...
            <span className="top-nav-address-text">IIIT NAGPUR, Near IITN Main Gat...</span>
