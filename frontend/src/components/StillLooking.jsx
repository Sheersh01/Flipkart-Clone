...
const items = [
  { img: bodyWash, label: 'Body Wash' },
  { img: mouse, label: 'Mouse' },
  { img: womensKurtas, label: "Women's Kurtas" },
  { img: chocolates, label: 'Chocolates' },
  { img: surgicalGloves, label: 'Surgical Gloves' },
  { img: mensShirt, label: "Men's Shirt" },
  { img: oxygenMeter, label: 'Oxygen Meter' },
];
    ...
    <section className="still-looking" id="still-looking">
      <div className="container still-looking-inner">
        ...
        <div className="still-looking-carousel">
          ...
          >
            {items.map((item, i) => (
              <a href="#" className="still-looking-card" key={i} id={`still-looking-${i}`}>
                <div className="still-looking-img-wrapper">
                  <img src={item.img} alt={item.label} className="still-looking-img" />
                </div>
